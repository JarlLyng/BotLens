...
BotLens uses [IAMJARL Design Tokens](https://github.com/JarlLyng/iamjarl-design). The mode-aware light/dark theme is driven entirely by tokens, so do not hardcode colors.
